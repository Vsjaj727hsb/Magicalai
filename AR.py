...
def get_inline_keyboard():
    ...
    button1 = InlineKeyboardButton("🔰 𝗰𝗼𝗻𝘁𝗮𝗰𝘁 𝘁𝗼 𝗼𝘄𝗻𝗲𝗿 🔰", url="https://t.me/+sUHNz0xm_205MTBl")
    button2 = InlineKeyboardButton("⭐ 𝗷𝗼𝗶𝗻 𝘁𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ⭐", url="https://t.me/+sUHNz0xm_205MTBl")
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝗼𝗻𝗹𝘆 𝗮𝗱𝗺𝗶𝗻 𝗰𝗮𝗻 𝗿𝘂𝗻 𝘁𝗵𝗶𝘀 𝗰𝗼𝗺𝗺𝗮𝗻𝗱"
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"🍀𝘂𝘀𝗲𝗿 {username} 💎\n\n⚡ 𝗔𝗧𝗧𝗔𝗖𝗞 𝗦𝗧𝗔𝗥𝗧𝗘𝗗 ⚡\n\n🎯 𝗛𝗢𝗦𝗧: {target}\n👙 𝗣𝗢𝗥𝗧: {port}\n⏳𝗧𝗜𝗠𝗘: {time} 𝗦𝗘𝗖𝗢𝗡𝗗𝗦\n 𝘀𝗲𝗻𝗱 𝗳𝗲𝗲𝗱𝗯𝗮𝗰𝗸 𝘁𝗼 𝗼𝘄𝗻𝗲𝗿:- @RajOwner90"
    bot.reply_to(message, response, reply_markup=get_inline_keyboard())
...
def handle_bgmi_command(message):
    ...
    if user_id in cooldown_tracker:
        ...
        if elapsed_time < COOLDOWN_DURATION:
            ...
            response = f"⏳ You are on cooldown. Please wait {remaining_time} seconds before using the /bgmi command again."
            bot.reply_to(message, response, reply_markup=get_inline_keyboard())
            return
    ...
    if len(command) == 4:  # Ensure the command has the correct format
        ...
        response = "⚠️ Invalid command format. Example: /bgmi <IP> <Port> <Time>"
...
def show_help(message):
 ...
 𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗𝗦 𝗔𝗟𝗢𝗡𝗘𝗕𝗢𝗬 𝗮𝗻𝗱 𝗥𝗔𝗝𝗢𝗪𝗡𝗘𝗥
'''
...
def welcome_start(message):
    ...
    response = f"𝗪𝗘𝗟𝗖𝗢𝗠𝗘, {user_name}! 𝗙𝗘𝗘𝗟 𝗙𝗥𝗘𝗘 𝗧𝗢 𝗘𝗫𝗣𝗟𝗢𝗥𝗘.\n𝗧𝗥𝗬 𝗧𝗢 𝗥𝗨𝗡 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗: /help\n\n 𝗢𝗪𝗡𝗘𝗥𝗦 :- @RajOwner90 @GODxAloneBOY"
    bot.reply_to(message, response, reply_markup=get_inline_keyboard())
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, 𝗣𝗟𝗔𝗡𝗘 𝗗𝗘𝗞𝗛𝗘𝗚𝗔 𝗟𝗔𝗨𝗗𝗘
'''
